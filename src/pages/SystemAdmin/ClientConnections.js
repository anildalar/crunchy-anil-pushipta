...
import { url, fetchOption, SSLTypes, LogLevels, HTTP_DLR_Param_Types, HTTP_DLR_Method, HTTP_DLR_Type, HTTP_Response_Type, timeZone, Bill_Mode, yesNo, BindType, ChargeType, Active, httpParam } from "../../helpers/helper";
                ...
                <div className="card-body">
                  <form className="form-horizontal" onSubmit={submit}>
                      ...
                      <div className=" tab-menu-heading">
                        <div className="tabs-menu1">
                          <ul className="nav panel-tabs main-nav-line">
                            <li><a href="#tab3" className="nav-link active" data-bs-toggle="tab">{t('Connection')}</a></li>
                            <li><a href="#tab4" className="nav-link " data-bs-toggle="tab">{t('SMPP')}</a></li>
                          ...
                          <div className="tab-pane active" id="tab3">
                            <div className="row row-sm">
                              <div className="col-lg-4 col-xl-4 col-md-4 col-sm-4 mb-3">
                                ...
                                <select name="routeType" className="form-control" onChange={e => handleChange(e)}>
                              ...
                              <div className="col-lg-4 col-xl-4 col-md-4 col-sm-4 mb-3">
                                ...
                                <select onChange={e => handleRoute(e)} name="route" className="form-control" >
                              ...
                              <div className="col-lg-4 col-xl-4 col-md-4 col-sm-4 mb-3">
                                <p className="mg-b-10">{t('Active')}</p>
                                <Select options={Active} onChange={e => coldataSelect(e, 'active')} />
                          ...
                          <div className="tab-pane" id="tab5">
                            <div className="row row-sm">
                              <div className="col-lg-4 col-xl-4 col-md-4 col-sm-4 mb-3">
                                ...
                                <Select options={httpParam} onChange={e => coldataSelect(e, 'httpParamType')}
                                />
                    ...
                    <div className="form-group row mb-0 mt-3 justify-content-end">
                      ...
                      <div className="col-lg-4 col-xl-4 col-md-4 col-sm-4 mb-3 mt-2">
                        <p className="mg-b-10">{t('Start Time')}</p>
                        <input onChange={e => collectdata(e)} type="time" id="appt" name="openTime" />
                        <span class="error openTime"></span>
                      </div>
                      <div className="col-lg-4 col-xl-4 col-md-4 col-sm-4 mb-3 mt-2">
                        <p className="mg-b-10">{t('Close Time')}</p>
                        <input onChange={e => collectdata(e)} type="time" id="appt" name="closeTime" />
                        <span className="error closeTime"></span>
                      </div>
                      <div>
