          ...
          <div className="breadcrumb-header justify-content-between">
            <div className="my-auto">
              <div className="d-flex">
                <h4 className="content-title mb-0 my-auto">Tables</h4>
            ...
            <div className="col-xl-12">
              <div className="card mg-b-20">
                <div className="card-header pb-0">
                  ...
                  <p className="tx-12 tx-gray-500 mb-2">
                    Example of Valex Bordered Table.. <a href="">Learn more</a>
                  </p>
                </div>
                <div className="card-body">
                  <div className="table-responsive">
                    <table
                      id="example"
                      className="table key-buttons text-md-nowrap"
                    >
                      <thead>
                        <tr>
                          <th className="border-bottom-0">Name</th>
                          <th className="border-bottom-0">Position</th>
                          <th className="border-bottom-0">Office</th>
            ...
            <div className="col-xl-12">
              <div className="card">
                <div className="card-header pb-0">
                  ...
                  <p className="tx-12 tx-gray-500 mb-2">
                    Example of Valex Hoverable Rows Table..{" "}
                    <a href="">Learn more</a>
                  </p>
                </div>
                <div className="card-body">
                  <div className="table-responsive hoverable-table">
                    <button id="button" className="btn btn-primary mg-b-20">
                      Delete selected row
                    </button>
                    <table id="example-delete" className="table text-md-nowrap">
                      <thead>
                        <tr>
                          <th>Name</th>
                          <th>Position</th>
