    ...
    return (
        <li aria-haspopup="true">
            ...
            <ul className="sub-menu">
                ...
                <li>
                    <NavLink className="" to="/newcreateuser">
                        New Create User
                    </NavLink>
                </li>
                <li>
                    <NavLink className="" to="/newuser">
                        New User
                    </NavLink>
                </li>
                <li>
                    <NavLink className="" to="/importrateeditor">
                        Import Rate Editor
                    </NavLink>
                </li>
                <li>
                    <NavLink className="" to="/getsmppconnection">
                        Get Vender SMPP Connection
                    </NavLink>
                </li>
                <li>
                    <NavLink className="" to="/gethttpdata">
                        Get Vender HTTP Connection
                    </NavLink>
                </li>
                <li>
                    <NavLink className="" to="/getconnection">
